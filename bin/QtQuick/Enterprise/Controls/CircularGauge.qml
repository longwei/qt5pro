...
/*!
    ...
    \l {QtQuick.Enterprise.Controls.Styles::CircularGaugeStyle::}{minimumValueAngle} and
    \l {QtQuick.Enterprise.Controls.Styles::CircularGaugeStyle::}{maximumValueAngle} properties of
    \l {QtQuick.Enterprise.Controls.Styles::}{CircularGaugeStyle}.
