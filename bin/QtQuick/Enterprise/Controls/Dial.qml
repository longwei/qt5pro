...
/*!
    ...
    \l {QtQuick.Enterprise.Controls.Styles::DialStyle::}{tickmarkStepSize},
    the dial "snaps" to each tickmark.

    You can create a custom appearance for a Dial by assigning a
    \l {QtQuick.Enterprise.Controls.Styles::}{DialStyle}.
*/
...
Control {
    ...
    */
    ...
    /*!
        ...
        style components of
        \l {QtQuick.Enterprise.Controls.Styles::}{DialStyle} can be used:

        \list
            \li \l {QtQuick.Enterprise.Controls.Styles::DialStyle::tickmark}{tickmark}
            \li \l {QtQuick.Enterprise.Controls.Styles::DialStyle::minorTickmark}{minorTickmark}
            \li \l {QtQuick.Enterprise.Controls.Styles::DialStyle::tickmarkLabel}{tickmarkLabel}
        \endlist
