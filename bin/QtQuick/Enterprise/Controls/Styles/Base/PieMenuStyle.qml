...
Style {
    ...
    */
    function sectionStartAngle(itemIndex) {
        return Utils.radToDegOffset(control.__protectedScope.sectionStartAngle(itemIndex));
    }
    ...
    */
    function sectionCenterAngle(itemIndex) {
        return Utils.radToDegOffset(control.__protectedScope.sectionCenterAngle(itemIndex));
    }
    ...
    */
    function sectionEndAngle(itemIndex) {
        return Utils.radToDegOffset(control.__protectedScope.sectionEndAngle(itemIndex));
    }
        ...
        Loader {
            ...
            sourceComponent: Image {
                ...
                readonly property point pos: Utils.centerAlongCircle(
                    ...
                    Utils.degToRadOffset(sectionCenterAngle(styleData.index)), __protectedScope.iconOffset)
